...
\section*{Amanda's Comments}
\begin{itemize}
\item Increase residual weight
\item Remove residual point selection
\item Increase the size of the non-local network
\item Do the wave equation with a larger network size
\item Soft attention mechanism and neural tangent kernel for training the hyper-parameters
\item Training to 500 with wave equation converged
