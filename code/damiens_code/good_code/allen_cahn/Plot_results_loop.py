    ...
    for Tmax in Tmaxes:
        for learning_rate in learning_rates:
            for decay_rate in decay_rates:
                for width in widths:
                    path = 'C:/Users/beec613/Desktop/pnnl_research/code/damiens_code/good_code/allen_cahn/out_results/cahn_0_' + str(Tmax) + '_' + str(learning_rate) + '_' + str(decay_rate) + '_' + str(width) + '/'
                    # A
