...
if __name__ == "__main__":
    ...
    # path_to_AC = "C:/Users/beec613/Desktop/pnnl_research/code/damiens_code/good_code/allen_cahn/onet_scripts/"
    # path = "C:/Users/beec613/Desktop/pnnl_research/code/damiens_code/good_code/allen_cahn/out_results/cahn_" + str(int(ymin_A)) + "_" + str(ymin_B) + "_" + str(init_lr) + "_" + str(decay) + "_" + str(N_nl)
    
    path_to_AC = "/people/beec613/pnnl_research/code/damiens_code/good_code/allen_cahn/onet_scripts/"
    path = "/people/beec613/pnnl_research/code/damiens_code/good_code/allen_cahn/out_results/cahn_" + str(int(ymin_A)) + "_" + str(ymin_B) + "_" + str(init_lr) + "_" + str(decay) + "_" + str(N_nl)
    # ====================================
    # saving settings
    # ====================================
