...
if __name__ == "__main__":
    ...
    # saving settings
    # ====================================
    # path_to_wave = "C:/Users/beec613/Desktop/pnnl_research/code/damiens_code/good_code/wave_causal_dd/out_results/wave_" + str(int(ymin_A)) + "_" + str(ymin_B)
    path_to_wave = "/people/beec613/pnnl_research/code/damiens_code/good_code/wave_causal_dd/out_results/wave_" + str(int(ymin_A)) + "_" + str(ymin_B)
    save_str = "MF_loop"
