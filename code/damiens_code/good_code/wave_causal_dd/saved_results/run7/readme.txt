I used the parameters from onet2 and ran the code again. The results look better. The error actually decreased
on the second layer of the learning process.
