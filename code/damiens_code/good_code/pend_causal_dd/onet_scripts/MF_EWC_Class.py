...
class MF_class_EWC:
    ...
    def loss(self, params, ic_batch, res_batch, val_batch):
        ...
        # loss_data = self.loss_data(params, val_batch) # data loss is 0
        ...
        #     self.data_weight*loss_data+ self.pen_weight*weights # this is the original line
        
        loss =  self.ics_weight*loss_ics + self.res_weight*loss_res + self.pen_weight*weights
        return loss 
