...
if __name__ == "__main__":
    ...
    # path = "C:/Users/beec613/Desktop/pnnl_research/code/damiens_code/good_code/pend_dd"
    path = "/people/beec613/pnnl_research/code/damiens_code/good_code/pend_dd"
  ...
  #  res_weight = 100.0
    ...
    for step in steps_to_train:
        results_dir = path + "/out_results/pend_" + str(int(min_A)) + "_" + str(int(min_B)) + "/results_" + str(step) + "/"+save_str+"/"
